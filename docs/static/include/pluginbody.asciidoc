...
If you are using rvm as your ruby version manger, and rvm list shows jruby 1.7.19 as the current version you will need to
set the following before running bundle exec rake publish_gem.
export JRUBY_OPTS="--1.9"

If you do not set --1.9 you will get the following errors.
rake aborted!
```
GemPublisher::CliFacade::Error: ERROR:  While executing gem ... (RuntimeError)
