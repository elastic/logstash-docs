...
:changelog_url: https://github.com/logstash-plugins/logstash-output-tcp/blob/v6.2.1/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-ssl_cacert>> |a valid filesystem path|__Deprecated__
...
===== `ssl_cacert`
deprecated[6.2.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_certificate_authorities>>]
...
===== `ssl_cert`
deprecated[6.2.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_certificate>>]
...
===== `ssl_enable`
deprecated[6.2.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_enabled>>]
...
NOTE: This setting can be used only if <<{version}-plugins-{type}s-{plugin}-mode>> is `client`.

[id="{version}-plugins-{type}s-{plugin}-ssl_verify"]
===== `ssl_verify`
deprecated[6.2.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_client_authentication>> and <<{version}-plugins-{type}s-{plugin}-ssl_verification_mode>>]
