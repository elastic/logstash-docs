...
Any user-based security settings in your in your <<{version}-plugins-outputs-elasticsearch,{es} output plugin>> configuration are ignored and may cause errors.
