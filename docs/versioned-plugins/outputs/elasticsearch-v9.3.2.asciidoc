...
:changelog_url: https://github.com/logstash-plugins/logstash-output-elasticsearch/blob/v9.3.2/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-ilm_enabled>> |<<boolean,boolean>>|No
