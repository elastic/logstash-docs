...
:changelog_url: https://github.com/logstash-plugins/logstash-output-pipe/blob/v4.0.0/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-command>> |{logstash-ref}/configuration-file-structure.html#array[array]|Yes
