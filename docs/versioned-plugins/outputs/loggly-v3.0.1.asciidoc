...
| <<{version}-plugins-{type}s-{plugin}-can_retry>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-host>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-key>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-proto>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-proxy_host>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-proxy_password>> |<<password,password>>|No
| <<{version}-plugins-{type}s-{plugin}-proxy_port>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-proxy_user>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-retry_count>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-tag>> |<<string,string>>|No
|=======================================================================
