...
| <<{version}-plugins-{type}s-{plugin}-deleter_interval_secs>> |<<number,number>>|No
...
| <<{version}-plugins-{type}s-{plugin}-key_password>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-key_path>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-project_id>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-service_account>> |<<string,string>>|Yes
...
| <<{version}-plugins-{type}s-{plugin}-temp_directory>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-temp_file_prefix>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-uploader_interval_secs>> |<<number,number>>|No
|=======================================================================
