...
| <<{version}-plugins-{type}s-{plugin}-details>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-event_type>> |<<string,string>>, one of `["trigger", "acknowledge", "resolve"]`|No
| <<{version}-plugins-{type}s-{plugin}-incident_key>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-pdurl>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-service_key>> |<<string,string>>|Yes
|=======================================================================
