...
:changelog_url: https://github.com/logstash-plugins/logstash-output-riemann/blob/v3.0.1/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-map_fields>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|No
| <<{version}-plugins-{type}s-{plugin}-port>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
| <<{version}-plugins-{type}s-{plugin}-protocol>> |{logstash-ref}/configuration-file-structure.html#string[string], one of `["tcp", "udp"]`|No
| <<{version}-plugins-{type}s-{plugin}-riemann_event>> |{logstash-ref}/configuration-file-structure.html#hash[hash]|No
...
[id="{version}-plugins-{type}s-{plugin}-map_fields"]
===== `map_fields` 
...
[id="{version}-plugins-{type}s-{plugin}-riemann_event"]
===== `riemann_event` 
