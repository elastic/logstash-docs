...
:changelog_url: https://github.com/logstash-plugins/logstash-output-sqs/blob/v4.0.3/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-message_max_size>> |<<bytes,bytes>>|No
