...
:changelog_url: https://github.com/logstash-plugins/logstash-output-s3/blob/v4.1.8/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-storage_class>> |{logstash-ref}/configuration-file-structure.html#string[string], one of `["STANDARD", "REDUCED_REDUNDANCY", "STANDARD_IA"]`|No
