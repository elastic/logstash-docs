...
:changelog_url: https://github.com/logstash-plugins/logstash-output-elasticsearch/blob/v11.0.0/CHANGELOG.md
...
* <<{version}-plugins-{type}s-{plugin}-data_stream>> |<<string,string>>
