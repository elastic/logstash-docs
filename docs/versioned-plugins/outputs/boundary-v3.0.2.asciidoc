...
| <<{version}-plugins-{type}s-{plugin}-auto>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-bsubtype>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-btags>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-btype>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-end_time>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-org_id>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-start_time>> |<<string,string>>|No
|=======================================================================
