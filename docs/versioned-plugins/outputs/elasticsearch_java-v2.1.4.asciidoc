...
| <<{version}-plugins-{type}s-{plugin}-action>> |<<string,string>>, one of `["index", "delete", "create", "update", "create_unless_exists"]`|No
| <<{version}-plugins-{type}s-{plugin}-cluster>> |<<string,string>>|No
...
| <<{version}-plugins-{type}s-{plugin}-network_host>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-node_name>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-parent>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-pipeline>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-protocol>> |<<string,string>>, one of `["node", "transport"]`|No
...
| <<{version}-plugins-{type}s-{plugin}-transport_tcp_port>> |<<number,number>>|No
