...
:changelog_url: https://github.com/logstash-plugins/logstash-output-exec/blob/v3.1.1/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-quiet>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|No
|=======================================================================
...
[id="{version}-plugins-{type}s-{plugin}-quiet"]
===== `quiet` 
