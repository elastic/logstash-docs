...
:changelog_url: https://github.com/logstash-plugins/logstash-output-google_cloud_storage/blob/v4.4.0/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-output_format>> |{logstash-ref}/configuration-file-structure.html#string[string], one of `["json", "plain", nil]`|__Deprecated__
