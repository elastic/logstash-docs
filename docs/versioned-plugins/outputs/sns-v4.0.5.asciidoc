...
:changelog_url: https://github.com/logstash-plugins/logstash-output-sns/blob/v4.0.5/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-arn>> |<<string,string>>|No
...
| <<{version}-plugins-{type}s-{plugin}-publish_boot_message_arn>> |<<string,string>>|No
...
[id="{version}-plugins-{type}s-{plugin}-arn"]
===== `arn` 
...
[id="{version}-plugins-{type}s-{plugin}-publish_boot_message_arn"]
