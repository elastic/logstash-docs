...
:changelog_url: https://github.com/logstash-plugins/logstash-output-s3/blob/v4.0.11/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-canned_acl>> |{logstash-ref}/configuration-file-structure.html#string[string], one of `["private", "public-read", "public-read-write", "authenticated-read"]`|No
