...
:changelog_url: https://github.com/logstash-plugins/logstash-output-rabbitmq/blob/v4.0.9/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-exchange>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-exchange_type>> |<<string,string>>, one of `["fanout", "direct", "topic", "x-consistent-hash", "x-modulus-hash"]`|Yes
...
| <<{version}-plugins-{type}s-{plugin}-message_properties>> |<<Hash,Hash>>|No
| <<{version}-plugins-{type}s-{plugin}-passive>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-password>> |<<password,password>>|No
| <<{version}-plugins-{type}s-{plugin}-persistent>> |<<boolean,boolean>>|No
