...
:changelog_url: https://github.com/logstash-plugins/logstash-output-nagios/blob/v3.0.3/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-commandfile>> |<<,>>|No
| <<{version}-plugins-{type}s-{plugin}-nagios_level>> |{logstash-ref}/configuration-file-structure.html#string[string], one of `["0", "1", "2", "3"]`|No
|=======================================================================
...
[id="{version}-plugins-{type}s-{plugin}-commandfile"]
===== `commandfile` 
...
[id="{version}-plugins-{type}s-{plugin}-nagios_level"]
===== `nagios_level` 
