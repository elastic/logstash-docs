...
| <<{version}-plugins-{type}s-{plugin}-multi_value>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-timeout>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-zabbix_host>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-zabbix_key>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-zabbix_server_host>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-zabbix_server_port>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-zabbix_value>> |<<string,string>>|No
|=======================================================================
