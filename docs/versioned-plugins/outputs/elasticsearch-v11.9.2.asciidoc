...
:changelog_url: https://github.com/logstash-plugins/logstash-output-elasticsearch/blob/v11.9.2/CHANGELOG.md
...
To enable request compression, use the <<{version}-plugins-{type}s-{plugin}-http_compression>>
