...
:changelog_url: https://github.com/logstash-plugins/logstash-output-nagios_nsca/blob/v3.0.5/CHANGELOG.md
...
=== Nagios_nsca output plugin {version}
...
| <<{version}-plugins-{type}s-{plugin}-nagios_host>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
| <<{version}-plugins-{type}s-{plugin}-nagios_service>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
| <<{version}-plugins-{type}s-{plugin}-nagios_status>> |{logstash-ref}/configuration-file-structure.html#string[string]|Yes
| <<{version}-plugins-{type}s-{plugin}-port>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
| <<{version}-plugins-{type}s-{plugin}-send_nsca_bin>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
| <<{version}-plugins-{type}s-{plugin}-send_nsca_config>> |a valid filesystem path|No
|=======================================================================
...
[id="{version}-plugins-{type}s-{plugin}-nagios_host"]
===== `nagios_host` 
...
[id="{version}-plugins-{type}s-{plugin}-nagios_service"]
===== `nagios_service` 
...
[id="{version}-plugins-{type}s-{plugin}-nagios_status"]
===== `nagios_status` 
...
[id="{version}-plugins-{type}s-{plugin}-send_nsca_bin"]
===== `send_nsca_bin` 
...
[id="{version}-plugins-{type}s-{plugin}-send_nsca_config"]
===== `send_nsca_config` 
