...
:changelog_url: https://github.com/logstash-plugins/logstash-output-zabbix/blob/v3.0.2/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-multi_value>> |{logstash-ref}/configuration-file-structure.html#array[array]|No
| <<{version}-plugins-{type}s-{plugin}-timeout>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
| <<{version}-plugins-{type}s-{plugin}-zabbix_host>> |{logstash-ref}/configuration-file-structure.html#string[string]|Yes
| <<{version}-plugins-{type}s-{plugin}-zabbix_key>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
| <<{version}-plugins-{type}s-{plugin}-zabbix_server_host>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
| <<{version}-plugins-{type}s-{plugin}-zabbix_server_port>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
| <<{version}-plugins-{type}s-{plugin}-zabbix_value>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
|=======================================================================
...
[id="{version}-plugins-{type}s-{plugin}-multi_value"]
===== `multi_value` 
...
[id="{version}-plugins-{type}s-{plugin}-zabbix_host"]
===== `zabbix_host` 
...
[id="{version}-plugins-{type}s-{plugin}-zabbix_key"]
===== `zabbix_key` 
...
[id="{version}-plugins-{type}s-{plugin}-zabbix_server_host"]
===== `zabbix_server_host` 
...
[id="{version}-plugins-{type}s-{plugin}-zabbix_server_port"]
===== `zabbix_server_port` 
...
[id="{version}-plugins-{type}s-{plugin}-zabbix_value"]
===== `zabbix_value` 
