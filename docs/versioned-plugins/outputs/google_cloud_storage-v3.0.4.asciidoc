...
| <<{version}-plugins-{type}s-{plugin}-gzip>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-key_password>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-key_path>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-log_file_prefix>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-max_file_size_kbytes>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-output_format>> |<<string,string>>, one of `["json", "plain"]`|No
