...
:changelog_url: https://github.com/logstash-plugins/logstash-integration-aws/blob/v7.1.4/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-storage_class>> |{logstash-ref}/configuration-file-structure.html#string[string], one of `["STANDARD", "REDUCED_REDUNDANCY", "STANDARD_IA", "ONEZONE_IA"]`|No
