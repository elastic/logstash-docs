...
| <<{version}-plugins-{type}s-{plugin}-batch_number>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-context>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-error_file>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-host>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-integration>> |<<string,string>>, one of `["udp", "tcp", "rmi", "rest"]`|No
