...
:changelog_url: https://github.com/logstash-plugins/logstash-integration-logstash/blob/v1.0.0/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-hosts>> |list of {logstash-ref}/configuration-file-structure.html#string[string] |Yes
...
* Value type is list of {logstash-ref}/configuration-file-structure.html#string[string]
