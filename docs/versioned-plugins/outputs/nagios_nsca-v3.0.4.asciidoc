...
| <<{version}-plugins-{type}s-{plugin}-message_format>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-nagios_host>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-nagios_service>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-nagios_status>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-port>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-send_nsca_bin>> |<<string,string>>|No
