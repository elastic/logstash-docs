...
:changelog_url: https://github.com/logstash-plugins/logstash-output-google_cloud_storage/blob/v3.3.0/CHANGELOG.md
...
=== Google_cloud_storage output plugin {version}
...
| <<{version}-plugins-{type}s-{plugin}-key_password>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
| <<{version}-plugins-{type}s-{plugin}-key_path>> |{logstash-ref}/configuration-file-structure.html#string[string]|Yes
...
| <<{version}-plugins-{type}s-{plugin}-service_account>> |{logstash-ref}/configuration-file-structure.html#string[string]|Yes
