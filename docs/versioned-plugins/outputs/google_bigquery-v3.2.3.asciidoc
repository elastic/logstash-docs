...
=== Google_bigquery output plugin {version}
...
| <<{version}-plugins-{type}s-{plugin}-deleter_interval_secs>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
...
| <<{version}-plugins-{type}s-{plugin}-temp_file_prefix>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
