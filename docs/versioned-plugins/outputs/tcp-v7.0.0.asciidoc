...
:changelog_url: https://github.com/logstash-plugins/logstash-output-tcp/blob/v7.0.0/CHANGELOG.md
...
|=======================================================================
|Setting|Replaced by
| ssl_cacert |<<{version}-plugins-{type}s-{plugin}-ssl_certificate_authorities>>
