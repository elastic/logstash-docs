...
| <<{version}-plugins-{type}s-{plugin}-arn>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
...
| <<{version}-plugins-{type}s-{plugin}-publish_boot_message_arn>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
