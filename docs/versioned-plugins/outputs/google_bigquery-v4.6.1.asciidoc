...
:changelog_url: https://github.com/logstash-plugins/logstash-output-google_bigquery/blob/v4.6.1/CHANGELOG.md
...
added[4.0.0, "Replaces <<{version}-plugins-{type}s-{plugin}-key_password>> and <<{version}-plugins-{type}s-{plugin}-service_account>>."]
