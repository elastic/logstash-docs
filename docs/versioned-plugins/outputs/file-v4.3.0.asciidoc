...
| <<{version}-plugins-{type}s-{plugin}-stale_cleanup_interval>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
...
[id="{version}-plugins-{type}s-{plugin}-stale_cleanup_interval"]
