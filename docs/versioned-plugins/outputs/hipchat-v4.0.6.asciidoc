...
:changelog_url: https://github.com/logstash-plugins/logstash-output-hipchat/blob/v4.0.6/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-token>> |{logstash-ref}/configuration-file-structure.html#password[password]|Yes
