...
| <<{version}-plugins-{type}s-{plugin}-nested_object_separator>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-port>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-reconnect_interval>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-resend_on_failure>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-timestamp_field>> |<<string,string>>|No
|=======================================================================
