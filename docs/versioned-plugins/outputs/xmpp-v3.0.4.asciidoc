...
| <<{version}-plugins-{type}s-{plugin}-message>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-password>> |<<password,password>>|Yes
| <<{version}-plugins-{type}s-{plugin}-rooms>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-user>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-users>> |<<array,array>>|No
|=======================================================================
