...
| <<{version}-plugins-{type}s-{plugin}-account_id>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-annotation>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-api_token>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-batch_size>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-counter>> |<<hash,hash>>|No
