...
| <<{version}-plugins-{type}s-{plugin}-count>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-decrement>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-gauge>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-host>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-increment>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-namespace>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-port>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-sample_rate>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-sender>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-set>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-timing>> |<<hash,hash>>|No
|=======================================================================
