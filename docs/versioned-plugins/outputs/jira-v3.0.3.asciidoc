...
| <<{version}-plugins-{type}s-{plugin}-assignee>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-host>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-issuetypeid>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-password>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-priority>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-projectid>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-reporter>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-summary>> |<<string,string>>|Yes
