...
:changelog_url: https://github.com/logstash-plugins/logstash-output-riak/blob/v3.0.1/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-bucket>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-bucket_props>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-enable_search>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-enable_ssl>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-indices>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-key_name>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-nodes>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-proto>> |<<string,string>>, one of `["http", "pb"]`|No
| <<{version}-plugins-{type}s-{plugin}-ssl_opts>> |<<hash,hash>>|No
|=======================================================================
