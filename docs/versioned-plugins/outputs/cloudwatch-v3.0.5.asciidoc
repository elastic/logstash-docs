...
:changelog_url: https://github.com/logstash-plugins/logstash-output-cloudwatch/blob/v3.0.5/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-dimensions>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-field_dimensions>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-field_metricname>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-field_namespace>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-field_unit>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-field_value>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-metricname>> |<<string,string>>|No
...
| <<{version}-plugins-{type}s-{plugin}-timeframe>> |<<string,string>>|No
...
| <<{version}-plugins-{type}s-{plugin}-value>> |<<string,string>>|No
|=======================================================================
