...
:changelog_url: https://github.com/logstash-plugins/logstash-output-file/blob/v4.2.2/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-write_behavior>> |<<string,string>>|No
|=======================================================================
