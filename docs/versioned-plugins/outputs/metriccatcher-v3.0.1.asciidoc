...
| <<{version}-plugins-{type}s-{plugin}-biased>> |<<hash,hash>>|No
...
| <<{version}-plugins-{type}s-{plugin}-meter>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-port>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-timer>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-uniform>> |<<hash,hash>>|No
|=======================================================================
