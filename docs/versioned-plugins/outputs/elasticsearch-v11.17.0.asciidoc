...
:changelog_url: https://github.com/logstash-plugins/logstash-output-elasticsearch/blob/v11.17.0/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-compression_level>> |<<number,number>>, one of `[0 ~ 9]`|No
