...
:changelog_url: https://github.com/logstash-plugins/logstash-output-csv/blob/v3.0.5/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-create_if_deleted>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-csv_options>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-dir_mode>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-fields>> |<<array,array>>|Yes
| <<{version}-plugins-{type}s-{plugin}-file_mode>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-filename_failure>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-flush_interval>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-gzip>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-path>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-spreadsheet_safe>> |<<boolean,boolean>>|No
|=======================================================================
