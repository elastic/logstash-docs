...
:changelog_url: https://github.com/logstash-plugins/logstash-codec-multiline/blob/v3.0.5/CHANGELOG.md
...
=== Multiline codec plugin {version}
...
| <<{version}-plugins-{type}s-{plugin}-auto_flush_interval>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
...
| <<{version}-plugins-{type}s-{plugin}-max_bytes>> |{logstash-ref}/configuration-file-structure.html#bytes[bytes]|No
| <<{version}-plugins-{type}s-{plugin}-max_lines>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
| <<{version}-plugins-{type}s-{plugin}-multiline_tag>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
...
[id="{version}-plugins-{type}s-{plugin}-auto_flush_interval"]
===== `auto_flush_interval` 
...
[id="{version}-plugins-{type}s-{plugin}-max_bytes"]
===== `max_bytes` 
...
[id="{version}-plugins-{type}s-{plugin}-max_lines"]
===== `max_lines` 
...
[id="{version}-plugins-{type}s-{plugin}-multiline_tag"]
===== `multiline_tag` 
