...
:changelog_url: https://github.com/logstash-plugins/logstash-codec-json_lines/blob/v3.2.2/CHANGELOG.md
...
=== Json_lines codec plugin {version}
...
| <<{version}-plugins-{type}s-{plugin}-decode_size_limit_bytes>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
...
[id="{version}-plugins-{type}s-{plugin}-decode_size_limit_bytes"]
