...
| <<{version}-plugins-{type}s-{plugin}-raw_data_field>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
...
[id="{version}-plugins-{type}s-{plugin}-raw_data_field"]
===== `raw_data_field`
