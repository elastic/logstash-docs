...
:changelog_url: https://github.com/logstash-plugins/logstash-codec-nmap/blob/v0.0.20/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-emit_hosts>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-emit_ports>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-emit_scan_metadata>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-emit_traceroute_links>> |<<boolean,boolean>>|No
|=======================================================================
