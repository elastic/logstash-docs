...
:changelog_url: https://github.com/logstash-plugins/logstash-codec-avro/blob/v3.2.2/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-schema_uri>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-tag_on_failure>> |<<boolean,boolean>>|No
|=======================================================================
