...
| <<{version}-plugins-{type}s-{plugin}-cache_ttl>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-include_flowset_id>> |<<boolean,boolean>>|No
...
| <<{version}-plugins-{type}s-{plugin}-versions>> |<<array,array>>|No
|=======================================================================
