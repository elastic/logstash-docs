...
| <<{version}-plugins-{type}s-{plugin}-close_older>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-delimiter>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-discover_interval>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-exclude>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-ignore_older>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-max_open_files>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-path>> |<<array,array>>|Yes
| <<{version}-plugins-{type}s-{plugin}-sincedb_path>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-sincedb_write_interval>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-start_position>> |<<string,string>>, one of `["beginning", "end"]`|No
| <<{version}-plugins-{type}s-{plugin}-stat_interval>> |<<number,number>>|No
|=======================================================================
