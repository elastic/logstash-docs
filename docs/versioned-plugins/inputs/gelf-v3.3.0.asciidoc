...
:changelog_url: https://github.com/logstash-plugins/logstash-input-gelf/blob/v3.3.0/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-use_udp>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|No
| <<{version}-plugins-{type}s-{plugin}-use_tcp>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|No
| <<{version}-plugins-{type}s-{plugin}-port>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
| <<{version}-plugins-{type}s-{plugin}-port_tcp>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
| <<{version}-plugins-{type}s-{plugin}-port_udp>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
...
[id="{version}-plugins-{type}s-{plugin}-use_udp"]
===== `use_udp`
...
[id="{version}-plugins-{type}s-{plugin}-use_tcp"]
===== `use_tcp`
...
[id="{version}-plugins-{type}s-{plugin}-port_tcp"]
===== `port_tcp`
...
[id="{version}-plugins-{type}s-{plugin}-port_udp"]
===== `port_udp`
