...
:changelog_url: https://github.com/logstash-plugins/logstash-input-google_cloud_storage/blob/v0.14.0/CHANGELOG.md
...
=== Google Cloud Storage Input Plugin {version}
