...
| <<{version}-plugins-{type}s-{plugin}-allow_partial_response>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|No
...
| <<{version}-plugins-{type}s-{plugin}-max_repetitions>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
...
[id="{version}-plugins-{type}s-{plugin}-max_repetitions"]
===== `max_repetitions`
...
[id="{version}-plugins-{type}s-{plugin}-allow_partial_response"]
...
The event will still be tagged with <<{version}-plugins-{type}s-{plugin}-tag_on_failure>> to indicate that an error occurred.
