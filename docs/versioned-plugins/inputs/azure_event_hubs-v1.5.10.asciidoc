...
:changelog_url: https://github.com/logstash-plugins/logstash-input-azure_event_hubs/blob/v1.5.10/CHANGELOG.md
...
If you are not ready to migrate, you can reduce the impact of GPv2 transactional costs by increasing the <<{version}-plugins-{type}s-{plugin}-checkpoint_interval>> setting above its default of `5` seconds. This reduces write operations to the Blob Storage account and lowers costs. You can estimate the cost difference using the https://azure.microsoft.com/en-us/pricing/calculator/[Azure Pricing Calculator].
...
* <<{version}-plugins-{type}s-{plugin}-bp-group>>
* <<{version}-plugins-{type}s-{plugin}-bp-multihub>>
* <<{version}-plugins-{type}s-{plugin}-bp-threads>>

[id="{version}-plugins-{type}s-{plugin}-bp-group"]
...
[id="{version}-plugins-{type}s-{plugin}-bp-multihub"]
...
[id="{version}-plugins-{type}s-{plugin}-bp-threads"]
