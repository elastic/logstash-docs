...
:changelog_url: https://github.com/logstash-plugins/logstash-input-beats/blob/v6.4.1/CHANGELOG.md
...
<<{version}-plugins-{type}s-{plugin}-ecs_compatibility,ECS compatibility mode>> is enabled
...
| <<{version}-plugins-{type}s-{plugin}-ssl_peer_metadata>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|No
