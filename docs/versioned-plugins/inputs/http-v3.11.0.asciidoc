...
:changelog_url: https://github.com/logstash-plugins/logstash-input-http/blob/v3.11.0/CHANGELOG.md
...
[id="{version}-plugins-{type}s-{plugin}-wire-logging"]
==== Enable wire logging
...
| <<{version}-plugins-{type}s-{plugin}-additional_codecs>> |{logstash-ref}/configuration-file-structure.html#hash[hash]|No
...
| <<{version}-plugins-{type}s-{plugin}-keystore>> |{logstash-ref}/configuration-file-structure.html#path[path]|__Deprecated__
...
| <<{version}-plugins-{type}s-{plugin}-max_pending_requests>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
| <<{version}-plugins-{type}s-{plugin}-response_headers>> |{logstash-ref}/configuration-file-structure.html#hash[hash]|No
| <<{version}-plugins-{type}s-{plugin}-response_code>> |{logstash-ref}/configuration-file-structure.html#number[number], one of `[200, 201, 202, 204]`|No
...
| <<{version}-plugins-{type}s-{plugin}-verify_mode>> |{logstash-ref}/configuration-file-structure.html#string[string], one of `["none", "peer", "force_peer"]`|__Deprecated__
|=======================================================================
...
===== `cipher_suites`
deprecated[3.6.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_cipher_suites>>]
...
===== `keystore`
deprecated[3.7.0, Use <<{version}-plugins-{type}s-{plugin}-ssl_keystore_path>> instead]
...
===== `keystore_password`
deprecated[3.7.0, Use <<{version}-plugins-{type}s-{plugin}-ssl_keystore_password>> instead]
...
[id="{version}-plugins-{type}s-{plugin}-max_content_length"]
===== `max_content_length`
...
[id="{version}-plugins-{type}s-{plugin}-max_pending_requests"]
...
[id="{version}-plugins-{type}s-{plugin}-response_code"]
===== `response_code`
...
[id="{version}-plugins-{type}s-{plugin}-remote_host_target_field"]
...
[id="{version}-plugins-{type}s-{plugin}-request_headers_target_field"]
...
===== `ssl`
deprecated[3.7.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_enabled>>]
...
===== `ssl_verify_mode`
deprecated[3.7.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_client_authentication>>]
...
===== `verify_mode`
deprecated[3.6.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_verify_mode>>]
