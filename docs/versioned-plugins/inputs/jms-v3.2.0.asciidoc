...
:changelog_url: https://github.com/logstash-plugins/logstash-input-jms/blob/v3.2.0/CHANGELOG.md
...
See <<{version}-plugins-{type}s-{plugin}-headers_target>>, <<{version}-plugins-{type}s-{plugin}-properties_target>> and <<{version}-plugins-{type}s-{plugin}-target>>.
...
| <<{version}-plugins-{type}s-{plugin}-durable_subscriber>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|No
| <<{version}-plugins-{type}s-{plugin}-durable_subscriber_client_id>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
| <<{version}-plugins-{type}s-{plugin}-durable_subscriber_name>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
...
| <<{version}-plugins-{type}s-{plugin}-factory_settings>> |{logstash-ref}/configuration-file-structure.html#hash[hash]|No
...
| <<{version}-plugins-{type}s-{plugin}-oracle_aq_buffered_messages>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|No
| <<{version}-plugins-{type}s-{plugin}-password>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
| <<{version}-plugins-{type}s-{plugin}-properties_target>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
...
| <<{version}-plugins-{type}s-{plugin}-runner>> |{logstash-ref}/configuration-file-structure.html#string[string]|__Deprecated__
| <<{version}-plugins-{type}s-{plugin}-selector>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
| <<{version}-plugins-{type}s-{plugin}-skip_headers>> |{logstash-ref}/configuration-file-structure.html#array[array]|No
| <<{version}-plugins-{type}s-{plugin}-skip_properties>> |{logstash-ref}/configuration-file-structure.html#array[array]|No
| <<{version}-plugins-{type}s-{plugin}-system_properties>> |{logstash-ref}/configuration-file-structure.html#hash[hash]|No
...
[id="{version}-plugins-{type}s-{plugin}-durable_subscriber"]
===== `durable_subscriber`
...
[id="{version}-plugins-{type}s-{plugin}-durable_subscriber_client_id"]
...
[id="{version}-plugins-{type}s-{plugin}-durable_subscriber_name"]
...
<<{version}-plugins-{type}s-{plugin}-properties_target>>.
...
[id="{version}-plugins-{type}s-{plugin}-factory_settings"]
===== `factory_settings`
...
The name of the field under which JMS headers will be added, if <<{version}-plugins-{type}s-{plugin}-include_headers>> is set.
...
To avoid pollution of the top-level namespace, when receiving a MapMessage, use the <<{version}-plugins-{type}s-{plugin}-target>>.
...
[id="{version}-plugins-{type}s-{plugin}-oracle_aq_buffered_messages"]
...
[id="{version}-plugins-{type}s-{plugin}-properties_target"]
===== `properties_target`
...
The name of the field under which JMS properties will be added, if <<{version}-plugins-{type}s-{plugin}-include_properties>> is set.
...
[id="{version}-plugins-{type}s-{plugin}-skip_headers"]
===== `skip_headers`
...
[id="{version}-plugins-{type}s-{plugin}-skip_properties"]
===== `skip_properties`
...
[id="{version}-plugins-{type}s-{plugin}-system_properties"]
===== `system_properties`
