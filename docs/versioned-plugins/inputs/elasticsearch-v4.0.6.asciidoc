...
:changelog_url: https://github.com/logstash-plugins/logstash-input-elasticsearch/blob/v4.0.6/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-docinfo>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-docinfo_fields>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-docinfo_target>> |<<string,string>>|No
...
| <<{version}-plugins-{type}s-{plugin}-scroll>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-size>> |<<number,number>>|No
