...
| <<{version}-plugins-{type}s-{plugin}-data_timeout>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-force_unlink>> |<<boolean,boolean>>|No
...
| <<{version}-plugins-{type}s-{plugin}-socket_not_present_retry_interval_seconds>> |<<number,number>>|Yes
|=======================================================================
