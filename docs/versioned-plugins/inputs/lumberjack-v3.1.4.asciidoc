...
:changelog_url: https://github.com/logstash-plugins/logstash-input-lumberjack/blob/v3.1.4/CHANGELOG.md
...
=== Lumberjack input plugin {version}
...
| <<{version}-plugins-{type}s-{plugin}-ssl_key>> |a valid filesystem path|Yes
