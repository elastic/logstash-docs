...
:changelog_url: https://github.com/logstash-plugins/logstash-integration-rabbitmq/blob/v7.4.1/CHANGELOG.md
...
[id="{version}-plugins-{type}s-{plugin}-metadata_locations"]
===== Metadata mapping
|=====
