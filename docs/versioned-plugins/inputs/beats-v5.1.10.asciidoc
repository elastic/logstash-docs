...
:changelog_url: https://github.com/logstash-plugins/logstash-input-beats/blob/v5.1.10/CHANGELOG.md
...
------------------------------------------------------------------------------
<1> Specifies the index to write events to. See <<{version}-plugins-{type}s-{plugin}-versioned-indexes>> for
