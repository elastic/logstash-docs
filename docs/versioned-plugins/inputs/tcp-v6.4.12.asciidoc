...
:changelog_url: https://github.com/logstash-plugins/logstash-input-tcp/blob/v6.4.12/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-ssl_cert>> |a valid filesystem path|__Deprecated__
...
| <<{version}-plugins-{type}s-{plugin}-ssl_cipher_suites>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
...
| <<{version}-plugins-{type}s-{plugin}-ssl_enable>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|__Deprecated__
...
| <<{version}-plugins-{type}s-{plugin}-ssl_verify>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|__Deprecated__
...
The value of this setting affects the <<{version}-plugins-{type}s-{plugin}-ecs_metadata,placement of a TCP connection's metadata>> on events.
...
===== `ssl_cert`
deprecated[6.4.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_certificate>>]
...
NOTE: This setting can be used only if <<{version}-plugins-{type}s-{plugin}-mode>> is `server` and <<{version}-plugins-{type}s-{plugin}-ssl_certificate_authorities>> is set.

[id="{version}-plugins-{type}s-{plugin}-ssl_enable"]
===== `ssl_enable`
deprecated[6.4.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_enabled>>]
...
This setting can be used only if <<{version}-plugins-{type}s-{plugin}-mode>> is `client`.
...
===== `ssl_verify`
deprecated[6.4.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_client_authentication>> and <<{version}-plugins-{type}s-{plugin}-ssl_verification_mode>>]
