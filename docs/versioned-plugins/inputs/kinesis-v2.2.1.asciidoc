...
:changelog_url: https://github.com/logstash-plugins/logstash-input-kinesis/blob/v2.2.1/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-http_proxy>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
