...
:changelog_url: https://github.com/logstash-plugins/logstash-input-beats/blob/v7.0.11/CHANGELOG.md
...
|=======================================================================
|Setting|Replaced by
| cipher_suites |<<{version}-plugins-{type}s-{plugin}-ssl_cipher_suites>>
| ssl |<<{version}-plugins-{type}s-{plugin}-ssl_enabled>>
| ssl_peer_metadata |<<{version}-plugins-{type}s-{plugin}-enrich>>
| ssl_verify_mode |<<{version}-plugins-{type}s-{plugin}-ssl_client_authentication>>
| tls_max_version |<<{version}-plugins-{type}s-{plugin}-ssl_supported_protocols>>
| tls_min_version |<<{version}-plugins-{type}s-{plugin}-ssl_supported_protocols>>
|=======================================================================
