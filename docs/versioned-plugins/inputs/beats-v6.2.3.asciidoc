...
:changelog_url: https://github.com/logstash-plugins/logstash-input-beats/blob/v6.2.3/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-add_hostname>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|No
