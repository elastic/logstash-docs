...
:changelog_url: https://github.com/logstash-plugins/logstash-input-beats/blob/v3.1.18/CHANGELOG.md
...
{logstash-ref}/plugins-codecs-multiline.html[multiline codec plugin] codec to handle multiline events. Doing so may
