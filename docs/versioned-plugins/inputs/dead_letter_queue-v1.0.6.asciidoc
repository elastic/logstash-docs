...
:changelog_url: https://github.com/logstash-plugins/logstash-input-dead_letter_queue/blob/v1.0.6/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-commit_offsets>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-path>> |a valid filesystem path|Yes
| <<{version}-plugins-{type}s-{plugin}-pipeline_id>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-sincedb_path>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-start_timestamp>> |<<string,string>>|No
|=======================================================================
