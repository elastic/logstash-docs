...
:changelog_url: https://github.com/logstash-plugins/logstash-input-http/blob/v4.2.1/CHANGELOG.md
...
| verify_mode |<<{version}-plugins-{type}s-{plugin}-ssl_client_authentication>>
|=======================================================================
