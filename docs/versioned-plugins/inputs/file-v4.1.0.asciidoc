...
:changelog_url: https://github.com/logstash-plugins/logstash-input-file/blob/v4.1.0/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-close_older>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
...
| <<{version}-plugins-{type}s-{plugin}-ignore_older>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
...
| <<{version}-plugins-{type}s-{plugin}-sincedb_clean_after>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
...
| <<{version}-plugins-{type}s-{plugin}-stat_interval>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
|=======================================================================
