...
:changelog_url: https://github.com/logstash-plugins/logstash-input-beats/blob/v4.0.1/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-cipher_suites>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-client_inactivity_timeout>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-host>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-include_codec_tag>> |<<boolean,boolean>>|No
...
| <<{version}-plugins-{type}s-{plugin}-ssl_verify_mode>> |<<string,string>>, one of `["none", "peer", "force_peer"]`|No
| <<{version}-plugins-{type}s-{plugin}-tls_max_version>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-tls_min_version>> |<<number,number>>|No
|=======================================================================
...
[id="{version}-plugins-{type}s-{plugin}-target_field_for_codec"]
