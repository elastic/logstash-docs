...
:changelog_url: https://github.com/logstash-plugins/logstash-input-dead_letter_queue/blob/v2.0.2/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-clean_consumed>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|No
...
[id="{version}-plugins-{type}s-{plugin}-clean_consumed"]
===== `clean_consumed`
