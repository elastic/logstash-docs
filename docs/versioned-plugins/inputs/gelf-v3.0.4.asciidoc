...
:changelog_url: https://github.com/logstash-plugins/logstash-input-gelf/blob/v3.0.4/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-remap>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-strip_leading_underscore>> |<<boolean,boolean>>|No
|=======================================================================
