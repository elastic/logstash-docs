...
:changelog_url: https://github.com/logstash-plugins/logstash-input-beats/blob/v6.9.10/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-event_loop_threads>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
...
[id="{version}-plugins-{type}s-{plugin}-event_loop_threads"]
===== `event_loop_threads`
...
See <<{version}-plugins-{type}s-{plugin}-executor_threads>> configuration if you need to set executor threads count.
