...
:changelog_url: https://github.com/logstash-plugins/logstash-input-google_pubsub/blob/v1.0.3/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-max_messages>> |<<number,number>>|Yes
| <<{version}-plugins-{type}s-{plugin}-project_id>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-subscription>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-topic>> |<<string,string>>|Yes
|=======================================================================
