...
:changelog_url: https://github.com/logstash-plugins/logstash-input-http_poller/blob/v3.3.3/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-metadata_target>> |<<string,string>>|No
...
| <<{version}-plugins-{type}s-{plugin}-schedule>> |<<hash,hash>>|No
...
| <<{version}-plugins-{type}s-{plugin}-urls>> |<<hash,hash>>|Yes
