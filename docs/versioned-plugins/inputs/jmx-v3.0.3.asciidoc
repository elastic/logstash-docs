...
:changelog_url: https://github.com/logstash-plugins/logstash-input-jmx/blob/v3.0.3/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-nb_thread>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
...
[id="{version}-plugins-{type}s-{plugin}-nb_thread"]
===== `nb_thread` 
