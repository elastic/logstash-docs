...
:changelog_url: https://github.com/logstash-plugins/logstash-input-http_poller/blob/v5.5.0/CHANGELOG.md
...
=== Http_poller input plugin {version}
...
| <<{version}-plugins-{type}s-{plugin}-metadata_target>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
...
| <<{version}-plugins-{type}s-{plugin}-schedule>> |{logstash-ref}/configuration-file-structure.html#hash[hash]|Yes
...
| <<{version}-plugins-{type}s-{plugin}-urls>> |{logstash-ref}/configuration-file-structure.html#hash[hash]|Yes
...
===== `cacert`
deprecated[5.5.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_certificate_authorities>>]
...
===== `client_cert`
deprecated[5.5.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_certificate>>]
...
===== `client_key`
deprecated[5.5.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_key>>]
...
===== `keystore`
deprecated[5.5.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_keystore_path>>]
...
===== `keystore_password`
deprecated[5.5.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_keystore_password>>]
...
===== `keystore_type`
deprecated[5.5.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_keystore_type>>]
...
[id="{version}-plugins-{type}s-{plugin}-metadata_target"]
===== `metadata_target`
...
Password to be used in conjunction with <<{version}-plugins-{type}s-{plugin}-user>> for HTTP authentication.
...
===== `truststore`
deprecated[5.5.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_truststore_path>>]
...
===== `truststore_password`
deprecated[5.5.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_truststore_password>>]
...
===== `truststore_type`
deprecated[5.5.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_truststore_type>>]
...
[id="{version}-plugins-{type}s-{plugin}-urls"]
===== `urls`
...
If you set this you must also set the <<{version}-plugins-{type}s-{plugin}-password>> option.
