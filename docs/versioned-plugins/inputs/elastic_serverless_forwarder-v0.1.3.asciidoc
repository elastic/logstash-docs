...
:changelog_url: https://github.com/logstash-plugins/logstash-input-elastic_serverless_forwarder/blob/v0.1.3/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-ssl>> |<<boolean,boolean>>|__Deprecated__
...
===== `ssl`
deprecated[0.1.3, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_enabled>>]
