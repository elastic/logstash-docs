...
:changelog_url: https://github.com/logstash-plugins/logstash-input-beats/blob/v6.6.1/CHANGELOG.md
...
This option needs to be used with <<{version}-plugins-{type}s-{plugin}-ssl_certificate_authorities>> and a defined list of CAs.
