...
:changelog_url: https://github.com/logstash-plugins/logstash-input-elasticsearch/blob/v4.23.0/CHANGELOG.md
...
===== `ca_file`
deprecated[4.17.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_certificate_authorities>>]
...
===== `ssl`
deprecated[4.17.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_enabled>>]
...
deprecated[4.17.0, Replaced by <<{version}-plugins-{type}s-{plugin}-ssl_verification_mode>>]
