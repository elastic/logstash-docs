...
:changelog_url: https://github.com/logstash-plugins/logstash-input-file/blob/v4.1.4/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-close_older>> |{logstash-ref}/configuration-file-structure.html#number[number] or <<plugins-{type}s-{plugin}-string_duration,string_duration>>|No
...
| <<{version}-plugins-{type}s-{plugin}-ignore_older>> |{logstash-ref}/configuration-file-structure.html#number[number] or <<plugins-{type}s-{plugin}-string_duration,string_duration>>|No
...
| <<{version}-plugins-{type}s-{plugin}-sincedb_clean_after>> |{logstash-ref}/configuration-file-structure.html#number[number] or <<plugins-{type}s-{plugin}-string_duration,string_duration>>|No
| <<{version}-plugins-{type}s-{plugin}-sincedb_path>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
| <<{version}-plugins-{type}s-{plugin}-sincedb_write_interval>> |{logstash-ref}/configuration-file-structure.html#number[number] or <<plugins-{type}s-{plugin}-string_duration,string_duration>>|No
...
| <<{version}-plugins-{type}s-{plugin}-stat_interval>> |{logstash-ref}/configuration-file-structure.html#number[number] or <<plugins-{type}s-{plugin}-string_duration,string_duration>>|No
|=======================================================================
...
===== `close_older`
  ...
  * Value type is {logstash-ref}/configuration-file-structure.html#number[number] or <<plugins-{type}s-{plugin}-string_duration,string_duration>>
