...
:changelog_url: https://github.com/logstash-plugins/logstash-input-zeromq/blob/v3.0.3/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-topic>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-topic_field>> |<<string,string>>|No
