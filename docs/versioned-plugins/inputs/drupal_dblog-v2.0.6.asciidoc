...
| <<{version}-plugins-{type}s-{plugin}-add_usernames>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-bulksize>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-databases>> |<<hash,hash>>|No
