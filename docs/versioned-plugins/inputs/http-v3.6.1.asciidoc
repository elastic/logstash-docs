...
:changelog_url: https://github.com/logstash-plugins/logstash-input-http/blob/v3.6.1/CHANGELOG.md
...
===== `keystore`
deprecated[3.1.0, Use <<{version}-plugins-{type}s-{plugin}-ssl_certificate>> and <<{version}-plugins-{type}s-{plugin}-ssl_key>> instead]
