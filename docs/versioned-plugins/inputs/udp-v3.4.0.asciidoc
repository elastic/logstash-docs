...
:changelog_url: https://github.com/logstash-plugins/logstash-input-udp/blob/v3.4.0/CHANGELOG.md
...
When ECS is enabled (in <<{version}-plugins-{type}s-{plugin}-ecs_compatibility>>), the
