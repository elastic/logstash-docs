...
:changelog_url: https://github.com/logstash-plugins/logstash-input-snmptrap/blob/v3.0.3/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-community>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-host>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-port>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-yamlmibdir>> |<<string,string>>|No
|=======================================================================
