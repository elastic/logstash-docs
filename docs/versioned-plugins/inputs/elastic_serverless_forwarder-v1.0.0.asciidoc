...
:changelog_url: https://github.com/logstash-plugins/logstash-input-elastic_serverless_forwarder/blob/v1.0.0/CHANGELOG.md
...
[id="{version}-plugins-{type}s-{plugin}-es-output-notes"]
