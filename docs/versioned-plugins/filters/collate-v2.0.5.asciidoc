...
| <<{version}-plugins-{type}s-{plugin}-count>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-interval>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-order>> |<<string,string>>, one of `["ascending", "descending"]`|No
|=======================================================================
