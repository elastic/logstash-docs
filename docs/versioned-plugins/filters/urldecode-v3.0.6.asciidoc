...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-urldecode/blob/v3.0.6/CHANGELOG.md
...
=== Urldecode filter plugin {version}
...
| <<{version}-plugins-{type}s-{plugin}-all_fields>> |<<boolean,boolean>>|No
...
[id="{version}-plugins-{type}s-{plugin}-all_fields"]
===== `all_fields` 
