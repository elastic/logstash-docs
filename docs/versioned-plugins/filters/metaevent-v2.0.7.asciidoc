...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-metaevent/blob/v2.0.7/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-followed_by_tags>> |<<array,array>>|Yes
