...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-split/blob/v3.1.10/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-terminator>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
|=======================================================================
