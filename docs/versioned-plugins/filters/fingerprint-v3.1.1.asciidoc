...
| <<{version}-plugins-{type}s-{plugin}-base64encode>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-concatenate_sources>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-concatenate_all_fields>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-key>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-method>> |<<string,string>>, one of `["SHA1", "SHA256", "SHA384", "SHA512", "MD5", "MURMUR3", "IPV4_NETWORK", "UUID", "PUNCTUATION"]`|Yes
| <<{version}-plugins-{type}s-{plugin}-source>> |<<array,array>>|No
