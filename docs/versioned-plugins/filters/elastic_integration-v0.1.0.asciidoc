...
:changelog_url: https://github.com/elastic/logstash-filter-elastic_integration/blob/v0.1.0/CHANGELOG.md
...
:prohibit-ssl-disabled-explicit: Cannot be combined with <<{version}-plugins-{type}s-{plugin}-ssl_enabled, `ssl_enabled \=> false`>>.
:prohibit-ssl-verify-none: Cannot be combined with <<{version}-plugins-{type}s-{plugin}-ssl_verification_mode, `ssl_verification_mode \=> none`>>.
