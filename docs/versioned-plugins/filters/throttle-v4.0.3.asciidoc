...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-throttle/blob/v4.0.3/CHANGELOG.md
...
=== Throttle filter plugin {version}
...
| <<{version}-plugins-{type}s-{plugin}-after_count>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
| <<{version}-plugins-{type}s-{plugin}-before_count>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
...
| <<{version}-plugins-{type}s-{plugin}-max_counters>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
...
[id="{version}-plugins-{type}s-{plugin}-after_count"]
===== `after_count` 
...
[id="{version}-plugins-{type}s-{plugin}-before_count"]
===== `before_count` 
...
[id="{version}-plugins-{type}s-{plugin}-max_counters"]
===== `max_counters` 
