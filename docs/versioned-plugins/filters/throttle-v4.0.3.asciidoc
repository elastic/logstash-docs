...
| <<{version}-plugins-{type}s-{plugin}-after_count>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-before_count>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-key>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-max_age>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-max_counters>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-period>> |<<string,string>>|No
|=======================================================================
