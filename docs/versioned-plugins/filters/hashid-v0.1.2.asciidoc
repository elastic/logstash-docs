...
| <<{version}-plugins-{type}s-{plugin}-add_timestamp_prefix>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-hash_bytes_used>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-key>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-method>> |<<string,string>>, one of `["SHA1", "SHA256", "SHA384", "SHA512", "MD5"]`|No
