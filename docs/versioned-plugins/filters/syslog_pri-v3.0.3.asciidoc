...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-syslog_pri/blob/v3.0.3/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-syslog_pri_field_name>> |<<string,string>>|No
