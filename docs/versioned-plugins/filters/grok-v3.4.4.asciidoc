...
| <<{version}-plugins-{type}s-{plugin}-break_on_match>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-keep_empty_captures>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-match>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-named_captures_only>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-overwrite>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-pattern_definitions>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-patterns_dir>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-patterns_files_glob>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-tag_on_failure>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-tag_on_timeout>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-timeout_millis>> |<<number,number>>|No
|=======================================================================
