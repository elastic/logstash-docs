...
| <<{version}-plugins-{type}s-{plugin}-code>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-init>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-path>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-script_params>> |<<hash,hash>>,{}|No
| <<{version}-plugins-{type}s-{plugin}-tag_on_exception>> |<<string,string>>,_rubyexception|No
|=======================================================================
