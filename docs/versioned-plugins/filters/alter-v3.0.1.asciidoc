...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-alter/blob/v3.0.1/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-coalesce>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-condrewrite>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-condrewriteother>> |<<array,array>>|No
|=======================================================================
