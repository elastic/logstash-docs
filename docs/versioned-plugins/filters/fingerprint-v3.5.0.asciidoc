...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-fingerprint/blob/v3.5.0/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-key>> |{logstash-ref}/configuration-file-structure.html#password[password]|No
| <<{version}-plugins-{type}s-{plugin}-method>> |{logstash-ref}/configuration-file-structure.html#string[string], one of `["SHA1", "SHA256", "SHA384", "SHA512", "MD5", "MURMUR3", "MURMUR3_128", IPV4_NETWORK", "UUID", "PUNCTUATION"]`|Yes
