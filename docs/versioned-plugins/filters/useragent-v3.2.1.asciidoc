...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-useragent/blob/v3.2.1/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-lru_cache_size>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-prefix>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-regexes>> |<<string,string>>|No
