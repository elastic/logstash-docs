...
| <<{version}-plugins-{type}s-{plugin}-drop_original_event>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-metric_field_name>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-metrics>> |<<array,array>>|Yes
| <<{version}-plugins-{type}s-{plugin}-value_field_name>> |<<string,string>>|No
|=======================================================================
