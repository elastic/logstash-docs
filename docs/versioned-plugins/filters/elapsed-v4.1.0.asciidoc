...
| <<{version}-plugins-{type}s-{plugin}-end_tag>> |{logstash-ref}/configuration-file-structure.html#string[string]|Yes
| <<{version}-plugins-{type}s-{plugin}-new_event_on_match>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|No
| <<{version}-plugins-{type}s-{plugin}-start_tag>> |{logstash-ref}/configuration-file-structure.html#string[string]|Yes
| <<{version}-plugins-{type}s-{plugin}-timeout>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
| <<{version}-plugins-{type}s-{plugin}-unique_id_field>> |{logstash-ref}/configuration-file-structure.html#string[string]|Yes
| <<{version}-plugins-{type}s-{plugin}-keep_start_event>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
|=======================================================================
...
[id="{version}-plugins-{type}s-{plugin}-end_tag"]
===== `end_tag` 
...
[id="{version}-plugins-{type}s-{plugin}-new_event_on_match"]
===== `new_event_on_match` 
...
[id="{version}-plugins-{type}s-{plugin}-start_tag"]
===== `start_tag` 
...
[id="{version}-plugins-{type}s-{plugin}-unique_id_field"]
===== `unique_id_field` 
...
[id="{version}-plugins-{type}s-{plugin}-keep_start_event"]
===== `keep_start_event`
