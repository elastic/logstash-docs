...
| <<{version}-plugins-{type}s-{plugin}-every>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-replay>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-time>> |<<string,string>>|No
|=======================================================================
