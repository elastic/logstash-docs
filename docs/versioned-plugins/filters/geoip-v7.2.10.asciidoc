...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-geoip/blob/v7.2.10/CHANGELOG.md
...
See
<<{version}-plugins-{type}s-{plugin}-database_license,Database License>> for more information.
