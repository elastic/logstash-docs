...
* <<{version}-plugins-{type}s-{plugin}-ssl_keystore_path>> and/or <<{version}-plugins-{type}s-{plugin}-ssl_keystore_password>>
...
<<{version}-plugins-{type}s-{plugin}-obsolete-options>> for more details.
...
| <<{version}-plugins-{type}s-{plugin}-docinfo_fields>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-enable_sort>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-fields>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-hosts>> |<<array,array>>|No
...
| <<{version}-plugins-{type}s-{plugin}-query>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-query_type>> |<<string,string>>, one of `["dsl", "esql"]`|No
| <<{version}-plugins-{type}s-{plugin}-query_params>> |<<hash,hash>> or <<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-query_template>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-result_size>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-retry_on_failure>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-retry_on_status>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-sort>> |<<string,string>>|No
...
| <<{version}-plugins-{type}s-{plugin}-tag_on_failure>> |<<array,array>>|No
