...
<<{version}-plugins-{type}s-{plugin}-normal>>

<<{version}-plugins-{type}s-{plugin}-skip>>

<<{version}-plugins-{type}s-{plugin}-append>>

<<{version}-plugins-{type}s-{plugin}-indirect>>
...
[id="{version}-plugins-{type}s-{plugin}-normal"]
...
[id="{version}-plugins-{type}s-{plugin}-skip"]
===== Skip field notation
...
[id="{version}-plugins-{type}s-{plugin}-append"]
...
[id="{version}-plugins-{type}s-{plugin}-indirect"]
