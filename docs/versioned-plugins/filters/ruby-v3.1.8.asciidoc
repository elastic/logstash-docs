...
NOTE: This plugin's concurrency-safety depends on your code. Be sure to read up on <<{version}-plugins-{type}s-{plugin}-concurrency,how to avoid concurrency issues>>.

[id="{version}-plugins-{type}s-{plugin}-using-inline-script"]
===== Inline ruby code
...
NOTE: Defining methods in the <<{version}-plugins-{type}s-{plugin}-code,`code` option>> can significantly reduce throughput. Use the <<{version}-plugins-{type}s-{plugin}-init,`init` option>> instead.

[id="{version}-plugins-{type}s-{plugin}-using-script-file"]
...
[id="{version}-plugins-{type}s-{plugin}-concurrency"]
 ...
 ** It is safe to _set_ Instance Variables in a <<{version}-plugins-{type}s-{plugin}-using-script-file,script>>-defined `register` function or with <<{version}-plugins-{type}s-{plugin}-init>>, but they should not be modified while processing events unless safe-guarded by mutual exclusion.
...
| <<{version}-plugins-{type}s-{plugin}-code>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
...
| <<{version}-plugins-{type}s-{plugin}-script_params>> |{logstash-ref}/configuration-file-structure.html#hash[hash],{}|No
| <<{version}-plugins-{type}s-{plugin}-tag_on_exception>> |{logstash-ref}/configuration-file-structure.html#string[string],_rubyexception|No
| <<{version}-plugins-{type}s-{plugin}-tag_with_exception_message>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean],_false|No
|=======================================================================
...
[id="{version}-plugins-{type}s-{plugin}-script_params"]
===== `script_params`
...
[id="{version}-plugins-{type}s-{plugin}-tag_with_exception_message"]
