...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-elasticsearch/blob/v3.15.1/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-retry_on_status>> |{logstash-ref}/configuration-file-structure.html#number[number list]|No
...
* Value type is {logstash-ref}/configuration-file-structure.html#number[number list]
