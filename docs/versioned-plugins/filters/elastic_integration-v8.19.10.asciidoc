...
:changelog_url: https://github.com/elastic/logstash-filter-elastic_integration/blob/v8.19.10/CHANGELOG.md
...
[id="{version}-plugins-{type}s-{plugin}-requirements"]
...
[id="{version}-plugins-{type}s-{plugin}-es-tips"]
...
[id="{version}-plugins-{type}s-{plugin}-troubleshooting"]
==== Troubleshooting
