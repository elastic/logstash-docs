...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-zeromq/blob/v3.0.1/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-add_tag_on_timeout>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-address>> |<<string,string>>|No
| <<{version}-plugins-{type}s-{plugin}-field>> |<<string,string>>|No
...
| <<{version}-plugins-{type}s-{plugin}-sentinel>> |<<string,string>>|No
