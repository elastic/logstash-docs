...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-multiline/blob/v3.0.3/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-allow_duplicates>> |<<boolean,boolean>>|No
...
| <<{version}-plugins-{type}s-{plugin}-stream_identity>> |<<string,string>>|No
