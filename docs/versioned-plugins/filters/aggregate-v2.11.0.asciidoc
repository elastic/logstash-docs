...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-aggregate/blob/v2.11.0/CHANGELOG.md
...
Otherwise events may be processed out of sequence and unexpected results can occur.
...
| <<{version}-plugins-{type}s-{plugin}-timeout_timestamp_field>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
| <<{version}-plugins-{type}s-{plugin}-map_count_warning_threshold>> |{logstash-ref}/configuration-file-structure.html#number[number]|No
|=======================================================================
...
[id="{version}-plugins-{type}s-{plugin}-timeout_timestamp_field"]
...
[id="{version}-plugins-{type}s-{plugin}-map_count_warning_threshold"]
