...
| <<{version}-plugins-{type}s-{plugin}-clones>> |{logstash-ref}/configuration-file-structure.html#array[array]|Yes
...
The value of this setting affects the behavior of the <<{version}-plugins-{type}s-{plugin}-clones>>
