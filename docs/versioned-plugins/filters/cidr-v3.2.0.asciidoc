...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-cidr/blob/v3.2.0/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-address_field>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
...
[id="{version}-plugins-{type}s-{plugin}-address_field"]
===== `address_field`
