...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-split/blob/v3.1.5/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-terminator>> |<<string,string>>|No
|=======================================================================
...
[id="{version}-plugins-{type}s-{plugin}-terminator"]
===== `terminator` 
