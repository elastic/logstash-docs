...
| <<{version}-plugins-{type}s-{plugin}-action>> |<<string,string>>, one of `["append", "replace"]`|No
| <<{version}-plugins-{type}s-{plugin}-failed_cache_size>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-failed_cache_ttl>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-hit_cache_size>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-hit_cache_ttl>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-hostsfile>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-max_retries>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-nameserver>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-resolve>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-reverse>> |<<array,array>>|No
