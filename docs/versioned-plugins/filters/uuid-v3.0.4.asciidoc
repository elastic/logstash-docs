...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-uuid/blob/v3.0.4/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-overwrite>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|No
