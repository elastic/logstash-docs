...
| <<{version}-plugins-{type}s-{plugin}-end_tag>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-new_event_on_match>> |<<boolean,boolean>>|No
| <<{version}-plugins-{type}s-{plugin}-start_tag>> |<<string,string>>|Yes
| <<{version}-plugins-{type}s-{plugin}-timeout>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-unique_id_field>> |<<string,string>>|Yes
|=======================================================================
