...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-xml/blob/v4.1.0/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-parser_options>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
...
[id="{version}-plugins-{type}s-{plugin}-parser_options"]
===== `parser_options`
