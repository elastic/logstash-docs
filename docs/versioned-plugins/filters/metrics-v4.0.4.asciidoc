...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-metrics/blob/v4.0.4/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-clear_interval>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-flush_interval>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-ignore_older_than>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-meter>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-percentiles>> |<<array,array>>|No
| <<{version}-plugins-{type}s-{plugin}-rates>> |<<array,array>>|No
