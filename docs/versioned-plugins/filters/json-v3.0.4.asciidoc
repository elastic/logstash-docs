...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-json/blob/v3.0.4/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-skip_on_invalid_json>> |<<boolean,boolean>>|No
