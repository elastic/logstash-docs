...
The destination fields specified in <<{version}-plugins-{type}s-{plugin}-fields>>, <<{version}-plugins-{type}s-{plugin}-aggregation_fields>>, and <<{version}-plugins-{type}s-{plugin}-docinfo_fields>> are relative to this target.
