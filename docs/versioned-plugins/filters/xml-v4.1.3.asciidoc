...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-xml/blob/v4.1.3/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-parse_options>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
...
[id="{version}-plugins-{type}s-{plugin}-parse_options"]
===== `parse_options`
...
[id="{version}-plugins-{type}s-{plugin}-xpath_resources"]
