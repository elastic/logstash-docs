...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-dissect/blob/v1.1.1/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-convert_datatype>> |<<hash,hash>>|No
