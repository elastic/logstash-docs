...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-jdbc_streaming/blob/v1.0.9/CHANGELOG.md
...
[id="{version}-plugins-{type}s-{plugin}-prepared_statements"]
==== Prepared Statements
...
| <<{version}-plugins-{type}s-{plugin}-prepared_statement_warn_on_constant_usage>> |{logstash-ref}/configuration-file-structure.html#boolean[boolean]|No
...
Array of bind values for the prepared statement. Use field references and constants. See the section on <<{version}-plugins-{type}s-{plugin}-prepared_statements,prepared_statements>> for more info.
...
[id="{version}-plugins-{type}s-{plugin}-prepared_statement_warn_on_constant_usage"]
