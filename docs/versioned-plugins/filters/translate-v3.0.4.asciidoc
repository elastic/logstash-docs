...
| <<{version}-plugins-{type}s-{plugin}-dictionary>> |<<hash,hash>>|No
| <<{version}-plugins-{type}s-{plugin}-dictionary_path>> |a valid filesystem path|No
| <<{version}-plugins-{type}s-{plugin}-exact>> |<<boolean,boolean>>|No
...
| <<{version}-plugins-{type}s-{plugin}-refresh_interval>> |<<number,number>>|No
| <<{version}-plugins-{type}s-{plugin}-regex>> |<<boolean,boolean>>|No
|=======================================================================
