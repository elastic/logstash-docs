...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-date/blob/v3.2.0/CHANGELOG.md
...
| <<{version}-plugins-{type}s-{plugin}-match>> |{logstash-ref}/configuration-file-structure.html#array[array]|No
| <<{version}-plugins-{type}s-{plugin}-precision>> |{logstash-ref}/configuration-file-structure.html#string[string]|No
...
{logstash-ref}/event-dependent-configuration.html#logstash-config-field-references[Field References]
...
[id="{version}-plugins-{type}s-{plugin}-precision"]
===== `precision`
