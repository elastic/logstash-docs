...
| <<plugins-filters-checksum,checksum>> | Creates a checksum based on fields in an event | https://github.com/logstash-plugins/logstash-filter-checksum[logstash-filter-checksum]
...
:edit_url: https://github.com/logstash-plugins/logstash-filter-checksum/edit/master/lib/logstash/filters/checksum.rb
...
:edit_url: https://github.com/logstash-plugins/logstash-filter-multiline/edit/master/lib/logstash/filters/multiline.rb
