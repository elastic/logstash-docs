...
| <<plugins-filters-truncate,truncate>> | Truncate fields longer than a given length. | https://github.com/logstash-plugins/logstash-filter-truncate[logstash-filter-truncate]
...
:edit_url: https://github.com/logstash-plugins/logstash-filter-translate/edit/master/lib/logstash/filters/truncate.rb
