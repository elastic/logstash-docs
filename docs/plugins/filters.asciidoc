...
| <<plugins-filters-elastic_integration,elastic_integration>> | Provides additional processing for Elastic integrations | https://github.com/elastic/logstash-filter-elastic_integration[logstash-filter-elastic_integration]
