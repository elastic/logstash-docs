...
| <<plugins-filters-empow-classifier,empow-classifier>> | description goes here  | https://github.com/empow/logstash-filter-empow-classifier[logstash-filter-empow-classifier]
