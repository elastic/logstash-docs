...
| <<plugins-filters-age,age>> | Calculates the age of an event. | https://github.com/logstash-plugins/logstash-filter-age[logstash-filter-age]
...
| <<plugins-filters-emoji,emoji>> | Maps syslog severity to emojis  | https://github.com/logstash-plugins/logstash-filter-emoji[logstash-filter-emoji]
