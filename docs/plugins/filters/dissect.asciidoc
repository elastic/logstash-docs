...
[IMPORTANT]
===============================
The Logstash 5.5.0 release will not work with the dissect filter out-of-the-box. To use this plugin, please update the dissect filter to v1.0.11 or higher by running:
