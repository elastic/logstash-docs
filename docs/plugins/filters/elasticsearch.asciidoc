...
For mode details, check out the {logstash-ref}/connecting-to-cloud.html#_cloud_auth[Logstash-to-Cloud documentation]
...
For mode details, check out the {logstash-ref}/connecting-to-cloud.html#_cloud_id[Logstash-to-Cloud documentation]
