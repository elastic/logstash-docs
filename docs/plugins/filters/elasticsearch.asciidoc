...
:changelog_url: https://github.com/logstash-plugins/logstash-filter-elasticsearch/blob/v3.7.0/CHANGELOG.md
...
For mode details, check out the https://www.elastic.co/guide/en/logstash/{branch}/connecting-to-cloud.html#_cloud_auth[Logstash-to-Cloud documentation]
...
For mode details, check out the https://www.elastic.co/guide/en/logstash/{branch}/connecting-to-cloud.html#_cloud_id[Logstash-to-Cloud documentation]
