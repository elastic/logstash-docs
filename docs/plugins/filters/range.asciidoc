...
* https://github.com/logstash-plugins/logstash-filter-range/blob/master/CHANGELOG.md#300[Changelog]
...
| <<plugins-filters-range-enable_metric>> |<<boolean,boolean>>|No|`true`
| <<plugins-filters-range-id>> |<<string,string>>|No|
...
[[plugins-filters-range-enable_metric]]
===== `enable_metric` 
