...
| <<plugins-codecs-protobuf,protobuf>> | Converts protobuf encoded messages into logstash events | https://github.com/logstash-plugins/logstash-codec-protobuf[logstash-codec-protobuf]
...
| <<plugins-codecs-sflow,sflow>> | Decodes sflow v5 flows  | https://github.com/logstash-plugins/logstash-codec-sflow[logstash-codec-sflow]
|=======================================================================
...
:edit_url: https://github.com/logstash-plugins/logstash-codec-protobuf/edit/master/lib/logstash/codecs/protobuf.rb
...
:edit_url: https://github.com/logstash-plugins/logstash-codec-sflow/edit/master/lib/logstash/codecs/sflow.rb
include::codecs/sflow.asciidoc[]
