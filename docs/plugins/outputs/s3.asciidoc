...
| <<plugins-outputs-s3-region>> |<<string,string>>, one of `["us-east-1", "us-west-1", "us-west-2", "eu-west-1", "ap-southeast-1", "ap-southeast-2", "ap-northeast-1", "sa-east-1", "us-gov-west-1"]`|No|`"us-east-1"`
...
| <<plugins-outputs-s3-temporary_directory>> |<<string,string>>|No|`"/var/folders/_n/n4w7mmts5f58nflsvnnk_l2w0000gn/T/logstash"`
...
===== `temporary_directory` 
  ...
  * Value type is <<string,string>>
  * Default value is `"/var/folders/_n/n4w7mmts5f58nflsvnnk_l2w0000gn/T/logstash"`
