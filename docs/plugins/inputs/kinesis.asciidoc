...
[id="plugins-{type}s-{plugin}-breaking-changes"]
==== Breaking changes in 3.0.0

Version 3.0.0 migrates the underlying Kinesis Client Library from 1.x to 2.x (AWS
SDK for Java v2). As part of this, the <<plugins-{type}s-{plugin}-additional_settings>>
...
objects. See <<plugins-{type}s-{plugin}-additional_settings>> for the full list of options.
