...
:changelog_url: https://github.com/logstash-plugins/logstash-input-snmp/blob/v1.3.3/CHANGELOG.md
...
Check out {logstash-ref}/plugins-integrations-snmp.html[Importing MIBs] for instructions.
