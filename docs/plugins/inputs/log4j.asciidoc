...
Next,
https://www.elastic.co/guide/en/beats/filebeat/6.3/filebeat-installation.html[install
...
https://www.elastic.co/guide/en/beats/filebeat/6.3/filebeat-configuration.html[Configure Filebeat].
...
https://www.elastic.co/guide/en/logstash/6.3/plugins-inputs-beats.html[the logstash beats input documentation].
