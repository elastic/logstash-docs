...
Next,
https://www.elastic.co/guide/en/beats/filebeat/5.6/filebeat-installation.html[install
...
https://www.elastic.co/guide/en/beats/filebeat/5.6/filebeat-configuration.html[Configure Filebeat].
...
https://www.elastic.co/guide/en/logstash/5.6/plugins-inputs-beats.html[the logstash beats input documentation].
