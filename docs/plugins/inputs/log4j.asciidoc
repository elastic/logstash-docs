...
Next,
https://www.elastic.co/guide/en/beats/filebeat/7.5/filebeat-installation.html[install
...
https://www.elastic.co/guide/en/beats/filebeat/7.5/filebeat-configuration.html[Configure Filebeat].
...
https://www.elastic.co/guide/en/logstash/7.5/plugins-inputs-beats.html[the logstash beats input documentation].
