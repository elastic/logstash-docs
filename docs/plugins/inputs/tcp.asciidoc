...
| <<plugins-inputs-tcp-codec>> |<<codec,codec>>|No
| <<plugins-inputs-tcp-enable_metric>> |<<boolean,boolean>>|No
| <<plugins-inputs-tcp-host>> |<<string,string>>|No
| <<plugins-inputs-tcp-id>> |<<string,string>>|No
| <<plugins-inputs-tcp-mode>> |<<string,string>>, one of `["server", "client"]`|No
| <<plugins-inputs-tcp-port>> |<<number,number>>|Yes
| <<plugins-inputs-tcp-proxy_protocol>> |<<boolean,boolean>>|No
| <<plugins-inputs-tcp-ssl_cert>> |a valid filesystem path|No
| <<plugins-inputs-tcp-ssl_enable>> |<<boolean,boolean>>|No
| <<plugins-inputs-tcp-ssl_extra_chain_certs>> |<<array,array>>|No
| <<plugins-inputs-tcp-ssl_key>> |a valid filesystem path|No
| <<plugins-inputs-tcp-ssl_key_passphrase>> |<<password,password>>|No
| <<plugins-inputs-tcp-ssl_verify>> |<<boolean,boolean>>|No
